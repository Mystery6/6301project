...
* ■ Real-world risks: 
1. For the intial card holder who have no former records, I cannot predict correctly whether they will pay on time or delinquent from the model. As they do not have the data like pay_0. So, the model may not fits well for these people.
...
3. About the decision model, this kind of model may offer a reference for the final decision, but on the importatnt thing, like detecting crime, this thing cannot be only determined by the former record. As when someone has had a crime, he or she may be regarded as criming again for the rest of life. But they may not have a crime again. Besides, for those people who has the first crime, the model cannot detect their bad behaviors because they have no record for crimal, so they may not be regarded as the crimal.
